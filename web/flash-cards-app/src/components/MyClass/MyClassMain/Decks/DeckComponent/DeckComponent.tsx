        ...
        return (
            <div className="deck-row">
                <div className="deck-checkbox deck-row-item" onClick={() => this.clickedCheckbox()}>
                    { !this.props.deck.checkbox ? undefined: <img src={process.env.PUBLIC_URL + '/assets/icons/checkmark-circle.png'} /> }
                </div>
                ...
                <div className="option-deck deck-row-item">
                    <img src={process.env.PUBLIC_URL + '/assets/icons/eye.png'}/>
                    <span>View Deck</span>
                </div>
                <div className="option-deck deck-row-item">
                    <img src={process.env.PUBLIC_URL + '/assets/icons/pencil.png'}/>
                    <span>Edit Deck</span>
                </div>
